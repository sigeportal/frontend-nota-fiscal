...
export default function NFePage() {
    ...
    async function carregarHistorico() {
        ...
        try {
            const res = await nfeService.listar({ limit: 100 })
        ...
        <div className="space-y-6">
            ...
            <div className="card">
                <div className="card-header flex items-center justify-between">
                    <h3 className="font-semibold text-gray-900">NF-e emitidas (servidor)</h3>
                    <button
                        type="button"
                ...
                <div className="card-body">
                    ...
                    {historico.length === 0 ? (
                        <p className="text-sm text-gray-500">Nenhuma NF-e emitida foi encontrada para este usuário.</p>
                    ) : (
